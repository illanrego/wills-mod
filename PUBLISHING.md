...
Status: **GitHub releases v1.0.0 + v1.0.1 LIVE** (v1.0.1 = Encounters Guide, battle HUD removed; user in-game tested), **GameBanana live**: https://gamebanana.com/mods/703606 (QoL, Gen1Recomp), **OFFICIALLY LISTED in the mod index**: https://github.com/bryanthaboi/gen1recomp-mod-index/pull/134 MERGED — entry live in the feed (bryanthaboi.github.io/gen1recomp-mod-index/data/index.json, wills_mod/Encounters Guide v1.0.1). The gallery PR (bryanthaboi/gen1recomp#1223) was CLOSED by the maintainer: "Mods do not go in the repo — they have their own repos and you can add them to the index." Next: GameBanana title update (user) → Discord announcement (bois.icu).
